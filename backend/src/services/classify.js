    ...
    messages: [
      {
        role: 'user',
        content: [
          'Extrae el tema del siguiente miedo en una o dos palabras: el sustantivo o concepto concreto que provoca el miedo.',
          'No respondas con frases, explicaciones ni artículos. Responde ÚNICAMENTE con las palabras del tema, sin punto final.',
          `Miedo: "${content}"`,
          'Tema:',
        ].join('\n'),
      },
...
function isValidTopic(topic) {
  ...
  return t.length >= 2 && /[a-záéíóúüñ]/i.test(t) && !/^(que|a|de|en|por|para|no|nada|nunca|muy|más)$/i.test(t);
}
